...
# for load, pad data
from reader import load_data, load_data_home
from keras.preprocessing.sequence import pad_sequences
# get the pad ID
from qa_data import PAD_ID
from ensemble_qa_model import QASystem
from util import ConfusionMatrix, Progbar, minibatches, dropPickle, loadPickle
...
tf.app.flags.DEFINE_string("model_type", 'MPCM', "Specify model type")
tf.app.flags.DEFINE_bool("download", True, "for work with codalab")
...
def main(_):
    ...
    # after this run: python code/evaluate.py data/squad/dev-v1.1.json dev-prediction.json
